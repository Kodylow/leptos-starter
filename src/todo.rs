...
pub fn TodoApp(cx: Scope) -> impl IntoView {
    ...
    view! {cx,
        ...
        <Router>
            ...
            <h1 class="text-6xl font-bold mb-4">"SteadySats"</h1>
            <div class="border-green-500 border-4 rounded-full w-64 h-64 flex items-center justify-center">
                <p class="text-6xl">${balance}</p>
            </div>
            <div class="flex mt-4">
                <button on:click=move |_| set_balance.update(|balance| *balance += 1) class="rounded-full px-6 py-2 m-1 bg-black text-white">
                    "Deposit"
                </button>
                <button on:click=move |_| set_balance.update(|balance| *balance -= 1) class="rounded-full px-6 py-2 m-1 bg-black text-white">
                    "Withdraw"
